...
class HomeProvider extends GetConnect {
  ...
  Future<AllPost?> getPost() async {
    ...
    final url = Uri.parse(BASE_URL+'all-posts');
        ...
        if (jsonResponse['status'] == 200) {
          ...
          // print("postStatus ////////" + finalResponse['status'].toString());
            ...
            // var jsonString = response.body;
             print("response_all_post,,,,,,,,,,,,,,,,,,,,,"+jsonResponse.toString());
             return AllPost.fromJson(jsonResponse);
  ...
  Future<NewsModel?> getNewsPost() async {
    ...
    if (response.statusCode == 200) {
      print("newwwwwwwwwwwwws //////////" + response.body.toString());

      var jsonResponse = json.decode(response.body);

      try {
        if (jsonResponse['status'] == 200) {
          print("newwwwwwwwwwwwws1111111111 ///" + jsonResponse['status'].toString());


           var jsonString = response.body;
          print("newwwwwwwwwwwwws222222222222,,,,,,,,,,,,,,,,,,,,,"+jsonResponse.toString());
