...
class UserPostProvider extends GetConnect {
  ...
  Future<UserGlobalPost?> getUserGeneralPost() async {
    ...
    final url = Uri.parse(BASE_URL+'user-posts-filtering/general_post');
    ...
    if (response.statusCode == 200) {
      ...
      try {
        if (jsonResponse['status'] == 200) {
          ...
          // var jsonString = response.body;
          return UserGlobalPost.fromJson(jsonResponse);
        }
      } catch (e) {
        print(e.toString());
      }
  ...
  Future<UserJobPost?> getUserJobPost() async {
    ...
    final url = Uri.parse(BASE_URL+'user-posts-filtering/job_post');
    ...
    if (response.statusCode == 200) {
      ...
      try {
        if (jsonResponse['status'] == 200) {
          ...
          // var jsonString = response.body;
          return UserJobPost.fromJson(jsonResponse);
        }
      } catch (e) {
        print(e.toString());
      }
