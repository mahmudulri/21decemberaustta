...
class UpdatePostController extends GetxController {
  ...
  Future<void> fetchUserAllPost() async {
    ...
    try {
        await UserPostProvider().getUserAllPost().then((value) {
        allPost.value = value!;
        postTitle.value = allPost.value.userAllPosts![0].userPost![index.value].postTitle.toString();
        postType.value = allPost.value.userAllPosts![0].userPost![index.value].postType.toString();
        postDescription.value = allPost.value.userAllPosts![0].userPost![index.value].postDescription.toString();
        fileName.value = allPost.value.userAllPosts![0].userPost![index.value].image.toString();
        tag.value = allPost.value.userAllPosts![0].userPost![index.value].tag.toString();


        print("deeeeeeeeeeeeeeeeeeeeeee"+postDescription.value.toString());
