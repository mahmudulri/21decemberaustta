...
import '../modules/user_post/controllers/update_post_controller.dart';
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: (){
                                    updatePostController.index.value = index;
                                    Get.to(
                                        () => EditGeneralPostView(),
                                      arguments: index
                                    );
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                        ...
                                        child: Padding(
                                          padding: EdgeInsets.all(8.0),
                                          child: Text(controller.jobPost.value.jobPosts![index].jobTitle.toString().length < 18 ?
                                              controller.jobPost.value.jobPosts![index].jobTitle.toString() :
                                               controller.jobPost.value.jobPosts![index].jobTitle.toString().substring(0,17)+"..",
                                              overflow: TextOverflow.ellipsis,
                                              style: GoogleFonts.poppins(
                                                  fontSize: screenWidth * 0.025
                                              )),
